//! Help spotlight tour steps for Boson ops routes.
//!
//! Inventory is registered via [`uf_help_macros::help_spotlight_step`]. Call
//! [`ensure_help_steps_linked`] from the host or [`crate::BosonRoutes`] so
...
/// Force-link Boson Help spotlight inventory into the host binary.
///
